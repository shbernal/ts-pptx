...
| `pptx-ts/math` | `import { latexToOmml } from "pptx-ts/math"` | Turning LaTeX and MathML into native equations | [Node only](#math-is-node-only) | [Math and LaTeX](../math-latex.md) |
