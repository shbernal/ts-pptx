...
| `pptx-ts/script` | `import { printScript, readModelToIr } from "pptx-ts/script"` | Turning a deck into the TypeScript that rebuilds it | Every runtime | [Deck to script](../reference/pptx-to-script.md) |
