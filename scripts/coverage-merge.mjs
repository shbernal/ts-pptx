...
//
// `locKey` and the two projection functions live in `coverage-project.mjs`: this script does
// its work at module scope, so nothing here can be imported without running the whole merge.
