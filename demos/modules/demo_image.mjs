...
function genSlide03(pptx) {
	...
	slide.addShape(ShapeType.rect, { x: 0.6, y: 4.65, w: 3, h: 2, fill: { color: BKGD_LRGRAY } });
	...
	slide.addShape(ShapeType.rect, { x: 5.3, y: 4.65, w: 3, h: 2, fill: { color: BKGD_LRGRAY } });
	...
	slide.addShape(ShapeType.rect, { x: 10, y: 4.65, w: 3, h: 1.5, fill: { color: BKGD_LRGRAY } });
	...
	slide.addShape(ShapeType.rect, { x: 7, y: 1.0, w: 6.0, h: 3.0, fill: { color: BKGD_LRGRAY } });
...
function genSlide05(pptx) {
	...
	// type:inner
	const shadow2 = { shadow: { type: "inner", transparency: 50, blur: 20, color: "000000", offset: 20, angle: 320 } };
	...
	// type:outer
	const shadow3 = { shadow: { type: "outer", transparency: 65, blur: 20, color: "000000", offset: 20, angle: 320 } };
