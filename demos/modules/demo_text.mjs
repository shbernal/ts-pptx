...
function genSlide02(pptx) {
	...
	slide.addText("Word-Level Formatting:", { x: 0.5, y: 0.6, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		[
			{ text: "Courier New ", options: { fontSize: 36, fontFace: "Courier New", color: SchemeColor.accent6 } },
			{ text: "36", options: { fontSize: 36, fontFace: "Courier New", color: SchemeColor.accent1, breakLine: true } },
			{ text: "Arial ", options: { fontSize: 48, fontFace: "Arial", color: SchemeColor.accent2 } },
			{ text: "48", options: { fontSize: 48, fontFace: "Courier New", color: SchemeColor.accent1, breakLine: true } },
			{ text: "Verdana 48", options: { fontSize: 48, fontFace: "Verdana", color: SchemeColor.accent3, align: "left", breakLine: true } },
			{
				text: "\nStrikethrough",
				options: { fontSize: 36, fontFace: "Arial", color: SchemeColor.accent6, align: "center", strike: true, breakLine: true },
			},
			{
				text: "Underline",
				options: { fontSize: 36, fontFace: "Arial", color: SchemeColor.accent2, align: "center", underline: true, breakLine: true },
			},
			{
				text: "FUN",
				options: {
					...
					align: "center",
					underline: { style: "wavy", color: SchemeColor.accent4 },
				},
			},
			{
				text: "derline",
				options: {
					fontFace: "Arial",
					fontSize: 48,
					color: SchemeColor.accent4,
					align: "center",
					underline: { style: "wavy", color: SchemeColor.accent5 },
					breakLine: true,
				},
			},
			{ text: " ", options: { breakLine: true } },
			{ text: "Also: ", options: { fontSize: 36, fontFace: "Arial", color: SchemeColor.accent5, align: "right" } },
			{ text: "highlighted", options: { fontSize: 36, fontFace: "Arial", color: SchemeColor.accent5, align: "right", highlight: "FFFF00" } },
			{ text: " text!", options: { fontSize: 36, fontFace: "Arial", color: SchemeColor.accent5, align: "right" } },
		],
		{ x: 0.5, y: 1.0, w: 5.75, h: 6.0, margin: 5, fill: { color: SchemeColor.text1 } },
	);

	// RIGHT COLUMN ------------------------------------------------------------

	// 1: Line-Breaks
	slide.addText("Line-Breaks:", { x: 7.0, y: 0.6, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
	...
	slide.addText("Line-Spacing (text):", { x: 7.0, y: 2.7, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		"lineSpacing (Exactly)\n40pt",
	...
	slide.addText("Line-Spacing (bullets):", { x: 7.0, y: 5.6, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
...
function genSlide03(pptx) {
	...
	slide.addText("Bullet Indent-Levels:", { x: 0.5, y: 0.6, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		[
			{ text: "Root-Level    ", options: { fontSize: 32, bullet: true, color: SchemeColor.accent3, indentLevel: 0 } },
			{ text: "Indent-Level 1", options: { fontSize: 32, bullet: true, color: SchemeColor.accent4, indentLevel: 1 } },
			{ text: "Indent-Level 2", options: { fontSize: 32, bullet: true, color: SchemeColor.accent5, indentLevel: 2 } },
			{ text: "Indent-Level 3", options: { fontSize: 32, bullet: true, color: SchemeColor.accent6, indentLevel: 3 } },
		],
		{ x: 0.5, y: 1.0, w: 5.75, h: 2.4, fill: { color: "232323" } },
	);

	slide.addText("Bullet Spacing (Indentation):", { x: 0.5, y: 3.5, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		[
			{ text: "bullet indent: 10", options: { bullet: { indent: 10 } } },
			{ text: "bullet indent: 30", options: { bullet: { indent: 30 } } },
		],
		{ x: 0.5, y: 3.9, w: 5.75, h: 0.5, color: "393939", fontFace: "Arial", fontSize: 12, fill: { color: SchemeColor.background2 } },
	);

	slide.addText("Bullet Styles:", { x: 0.5, y: 4.6, w: "40%", h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		[
			{ text: "style: arabicPeriod", options: { color: SchemeColor.accent2, bullet: { type: "number", numberType: "arabicPeriod" } } },
			{ text: "style: arabicPeriod", options: { color: SchemeColor.accent2, bullet: { type: "number", numberType: "arabicPeriod" } } },
			{
				text: "style: alphaLcPeriod",
				options: { color: SchemeColor.accent5, bullet: { type: "number", numberType: "alphaLcPeriod" }, indentLevel: 1 },
			},
			{
				text: "style: alphaLcPeriod",
				options: { color: SchemeColor.accent5, bullet: { type: "number", numberType: "alphaLcPeriod" }, indentLevel: 1 },
			},
			{
				...
				options: { color: SchemeColor.accent6, bullet: { type: "number", numberType: "romanLcPeriod" }, indentLevel: 2 },
			},
			{
				text: "style: romanLcPeriod",
				options: { color: SchemeColor.accent6, bullet: { type: "number", numberType: "romanLcPeriod" }, indentLevel: 2 },
		...
		{ x: 0.5, y: 5.0, w: 5.75, h: 2.0, fill: { color: SchemeColor.background2 }, color: SchemeColor.accent1 },
	);

	// RIGHT COLUMN ------------------------------------------------------------

	// 1: Regular bullets
	slide.addText('Bullet "Start At" number option:', { x: 7.0, y: 0.6, w: 5.75, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	...
	slide.addText("Bullets made with line breaks:", { x: 7.0, y: 1.95, w: 5.75, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	...
	slide.addText("Bullets and soft-line-break (shift+enter):", { x: 7.0, y: 3.5, w: 5.75, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		[
		...
		{ x: 7.0, y: 3.9, w: 5.75, h: 1.0, color: "393939", fontSize: 16, fill: SchemeColor.background2 },
	);

	// 3: Bullets: With custom unicode bullet characters
	slide.addText("Bullets with text objects:", { x: 7.0, y: 5.05, w: 5.75, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText(
		[
			{ text: "`bullet: { characterCode: '25BA' }`", options: { fontSize: 18, color: SchemeColor.accent1, bullet: { characterCode: "25BA" } } },
			{ text: "`bullet: { characterCode: '25D1' }`", options: { fontSize: 18, color: SchemeColor.accent5, bullet: { characterCode: "25D1" } } },
			{ text: "`bullet: { characterCode: '25CC' }`", options: { fontSize: 18, color: SchemeColor.accent6, bullet: { characterCode: "25CC" } } },
		...
		{ x: 7.0, y: 5.5, w: 5.75, h: 1.5, fontFace: "Arial", fill: SchemeColor.background2 },
	);
}
...
function genSlide04(pptx) {
	...
	slide.addText("Hyperlinks:", { x: 0.5, y: 0.6, w: "90%", h: 0.3, margin: 0.123, color: SchemeColor.accent1 });
	...
	slide.addText("Tab Stops:", { x: 0.5, y: 2.1, w: 12.0, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	...
	slide.addText("Text Outline:", { x: 0.5, y: 5.8, w: 3.0, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText("size:2", {
		...
		outline: { size: 2, color: SchemeColor.accent4 },
	});

	// 3b: Text Effects: Glow
	slide.addText("Text Glow:", { x: 3.9, y: 5.8, w: 5.0, h: 0.3, margin: 0, color: SchemeColor.accent1 });
	slide.addText("size:10", {
		...
		fontSize: 72,
		color: SchemeColor.accent1,
		glow: { size: 10, opacity: 0.25, color: SchemeColor.accent2 },
	});

	// 3c: Text Effects: Shadow
	let shadowOpts = { type: "outer", color: "696969", blur: 3, offset: 10, angle: 45, transparency: 40 };
	slide.addText("Text Shadow:", { x: 7.5, y: 5.8, w: 5.0, h: 0.3, margin: 0, color: SchemeColor.accent1 });
...
function genSlide05(pptx) {
	...
	slide.addText("fit:'none'  ", { x: 0.5, y: 0.6, w: 4, h: 0.3, color: SchemeColor.accent1, fill: { color: "ffffff" } });
	slide.addText("fit:'shrink'", { x: 4.5, y: 0.6, w: 4, h: 0.3, color: SchemeColor.accent1, fill: { color: "ffffff" } });
	slide.addText("fit:'resize'", { x: 8.5, y: 0.6, w: 4, h: 0.3, color: SchemeColor.accent1, fill: { color: "ffffff" } });
...
function genSlide06(pptx) {
	...
	slide.addText("TEXT1 on BACKGROUND2", { x: 0.5, y: 0.7, w: 6.0, h: 2.0, color: SchemeColor.text1, fill: { color: SchemeColor.background2 } });
	slide.addText("TEXT2 on BACKGROUND1", { x: 7.0, y: 0.7, w: 6.0, h: 2.0, color: SchemeColor.text2, fill: { color: SchemeColor.background1 } });

	slide.addText("ACCENT1", { x: 0.5, y: 3.25, w: 6.0, h: 1.0, color: "FFFFFF", fill: { color: SchemeColor.accent1 } });
	slide.addText("ACCENT2", { x: 7.0, y: 3.25, w: 6.0, h: 1.0, color: "FFFFFF", fill: { color: SchemeColor.accent2 } });
	slide.addText("ACCENT3", { x: 0.5, y: 4.7, w: 6.0, h: 1.0, color: "FFFFFF", fill: { color: SchemeColor.accent3 } });
	slide.addText("ACCENT4", { x: 7.0, y: 4.7, w: 6.0, h: 1.0, color: "FFFFFF", fill: { color: SchemeColor.accent4 } });
	slide.addText("ACCENT5", { x: 0.5, y: 6.15, w: 6.0, h: 1.0, color: "FFFFFF", fill: { color: SchemeColor.accent5 } });
	slide.addText("ACCENT6", { x: 7.0, y: 6.15, w: 6.0, h: 1.0, color: "FFFFFF", fill: { color: SchemeColor.accent6 } });

	// NEGATIVE TEST:
	//slide.addText("NEGTEST / NEGTEST", { x:0.5, y:0.5, w:'40%', h:0.38, color:SchemeColor.negtest01, fill:{color:SchemeColor.negtest02} });
}
