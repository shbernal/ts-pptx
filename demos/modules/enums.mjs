...
export const IMAGE_PATHS = {
	fediverse_tree: { path: "../common/images/fediverse_tree.jpg" },
	fediverse_actpub: { path: "../common/images/fediverse_actpub.png" },
	pixelfed_logo_svg: { path: "../common/images/pixelfed_icon.svg" },
	kritaSquare: { path: "../common/images/krita_square.jpg" },
	peace4: { path: "../common/images/peace4.png" },
	starlabsBkgd: { path: "../common/images/starlabs_bkgd.jpg" },
	starlabsLogo: { path: "../common/images/starlabs_logo.png" },
	wikimedia1: { path: "../common/images/wiki-example.jpg" },
	wikimedia2: { path: "../common/images/png-gradient-hex.png" },
	wikimedia_svg: { path: "../common/images/lock-green.svg" },
	ccCopyRemix: { path: "../common/images/cc_copyremix.gif" },
	ccLogo: { path: "../common/images/cc_logo.jpg" },
	ccLicenseComp: { path: "/common/images/cc_license_comp.png" },
	ccDjGif: { path: "../common/images/cc_dj.gif" },
	gifAnimTrippy: { path: "../common/images/trippy.gif" },
	chicagoBean: {
		path: "../common/images/chicago_bean_bohne.jpg",
	},
	sydneyBridge: {
		path: "../common/images/sydney_harbour_bridge_night.jpg",
	},
	nycSubway: { path: "../common/images/nyc-subway.png" },
	tokyoSubway: { path: "../common/images/tokyo-subway-route-map.jpg" },
	sample_aif: { path: "../common/media/sample.aif" },
	sample_avi: { path: "../common/media/sample.avi" },
	sample_m4v: { path: "../common/media/sample.m4v" },
	sample_mov: { path: "../common/media/sample.mov" },
	sample_mp4: { path: "../common/media/sample.mp4" },
	sample_mpg: { path: "../common/media/sample.mpg" },
	sample_mp3: { path: "../common/media/sample.mp3" },
	sample_wav: { path: "../common/media/sample.wav" },
	big_earth_mp4: { path: "/common/media/earth-big.mp4" },
	UPPERCASE: { path: "../common/images/UPPERCASE.PNG" },
	video_mp4_thumb: { path: "../common/images/video-mp4-thumb.png" },
};
