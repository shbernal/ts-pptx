...
module.exports = [
	{
		...
		fn: async () => {
			...
			assert(effects.length === 2,
				'expected 2 <p:sp> blocks; got ' + effects.length + '\n' + xml)
			assert(effects[0] !== '',
				'expected first shape to have <a:effectLst>; got: ' + xml)
			...
			assert(effects[0].indexOf('blurRad="76200"') !== -1,
				'expected blurRad="76200" in shared effectLst; got: ' + effects[0])
			assert(effects[0].indexOf('blurRad="967740000"') === -1,
	...
	},
	{
		...
		fn: async () => {
			...
			assert(a.indexOf('blurRad="76200"') !== -1,
				'expected blurRad="76200" in shape effectLst; got: ' + a)
			assert(b.indexOf('blurRad="76200"') !== -1,
				'expected blurRad="76200" in image effectLst; got: ' + b)
			assert(a.indexOf('blurRad="967740000"') === -1 && b.indexOf('blurRad="967740000"') === -1,
